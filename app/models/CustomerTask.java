...
public class CustomerTask extends Model {
  ...
  public enum TaskType {
    ...
    SendUserNotification, GFlagsKubernetesUpgrade, PauseUniverse, ResumeUniverse, PauseXClusterUniverses, ResumeXClusterUniverses, FailoverDrConfig, ResumeKubernetesUniverse, MultiTableBackup, EditBackupScheduleKubernetes, EditBackupSchedule, DestroyKubernetesUniverse, DestroyUniverse, CreateBackup, CreateBackupSchedule, CreateBackupScheduleKubernetes, CreateKubernetesUniverse, CreateUniverse, BackupUniverse, DeleteBackupSchedule, DeleteBackupScheduleKubernetes, DeleteDrConfig, EnableNodeAgentInUniverse, ReinstallNodeAgent, SyncDrConfig, SwitchoverDrConfig, EditDrConfig, RestartDrConfig, SetTablesDrConfig, CreateDrConfig, RestartXClusterConfig, RestoreBackup, DecommissionNode, RebootNodeInUniverse, RollbackKubernetesUpgrade, FinalizeKubernetesUpgrade, CertsRotateKubernetesUpgrade, RestartUniverseKubernetesUpgrade, SoftwareKubernetesUpgradeYB, SoftwareKubernetesUpgrade, ReadOnlyClusterCreate;

    public static TaskType ReadOnlyClusterDelete;
  ...
  public static CustomerTask create(
    ...
    th.customerUUID = null;//customer.getUuid();
    ...
    if (StringUtils.isEmpty(userEmail)) {
      String emailFromContext = null;//Util.maybeGetEmailFromContext();
      if (emailFromContext.equals("Unknown")) {
        String emailFromSchedule = null;//maybeGetEmailFromSchedule();
    ...
    String correlationId = (String) MDC.get(null);
